...
def fetch_new_trainingdata_from_pf(userdata, pf_data_dir):
    ...
    for exercise_link in r_json["exercises"]:
        ...
        gpx_dir = f'{pf_data_dir}/pf_data_{d_json["id"]}'
        os.mkdir(gpx_dir)
        if d_json["has-route"]:
